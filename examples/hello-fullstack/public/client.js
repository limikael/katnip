...
function O(n2, u3, t3, i3, o3, r3, f3, e3, c3, s3) {
  var a3, h3, p3, v3, w4, _3, g4, m3, x3, C3, M3, P3, $3, I2, H3, L3 = u3.type;
  ...
  n:
    if ("function" == typeof L3)
      try {
        if (m3 = u3.props, x3 = (a3 = L3.contextType) && i3[a3.__c], C3 = a3 ? x3 ? x3.props.value : a3.__ : i3, t3.__c ? g4 = (h3 = u3.__c = t3.__c).__ = h3.__E : ("prototype" in L3 && L3.prototype.render ? u3.__c = h3 = new L3(m3, C3) : (u3.__c = h3 = new b(m3, C3), h3.constructor = L3, h3.render = q), x3 && x3.sub(h3), h3.props = m3, h3.state || (h3.state = {}), h3.context = C3, h3.__n = i3, p3 = h3.__d = true, h3.__h = [], h3._sb = []), null == h3.__s && (h3.__s = h3.state), null != L3.getDerivedStateFromProps && (h3.__s == h3.state && (h3.__s = d({}, h3.__s)), d(h3.__s, L3.getDerivedStateFromProps(m3, h3.__s))), v3 = h3.props, w4 = h3.state, h3.__v = u3, p3)
          ...
          if (null == L3.getDerivedStateFromProps && m3 !== v3 && null != h3.componentWillReceiveProps && h3.componentWillReceiveProps(m3, C3), !h3.__e && (null != h3.shouldComponentUpdate && false === h3.shouldComponentUpdate(m3, h3.__s, C3) || u3.__v === t3.__v)) {
        ...
        if (h3.context = C3, h3.props = m3, h3.__P = n2, h3.__e = false, P3 = l.__r, $3 = 0, "prototype" in L3 && L3.prototype.render) {
...
// index.jsx
var hello_fullstack_exports = {};
__export(hello_fullstack_exports, {
  default: () => hello_fullstack_default
});
init_preact_shim();
function hello_fullstack_default() {
  return /* @__PURE__ */ _(k, null, /* @__PURE__ */ _("img", { src: "/ACAI.png", class: "w-20 h-20" }));
}

// ../../packages/katnip-tailwind/katnip-tailwind-isomain.jsx
...
(C2.prototype = new b()).isPureReactComponent = true, C2.prototype.shouldComponentUpdate = function(n2, t3) {
...
// node_modules/.katnip/main.jsx
var isoqModules = [hello_fullstack_exports, katnip_tailwind_isomain_exports];
var mains = [];
...
function main_default(props) {
  ...
  for (let Wrapper2 of wrappers)
    main = /* @__PURE__ */ _(Wrapper2, { ...props }, main);
...
var IsoqClient = class {
  ...
  getAppUrl(pathname) {
    if (!pathname)
      pathname = "";
    let u3 = new URL(urlJoin(this.appPathname, pathname), this.getUrl());
    return u3.toString();
  }
  getWindow() {
    return this.window;
